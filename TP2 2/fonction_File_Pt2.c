...
int menu_PFile_Pt()
{
    ...
    enfiler_PFile(pfile, 12);
    enfiler_PFile(pfile, 1);
    enfiler_PFile(pfile, 0);
    enfiler_PFile(pfile, 7);
    enfiler_PFile(pfile, 15);
    enfiler_PFile(pfile, 4);
    enfiler_PFile(pfile, 3);
    enfiler_PFile(pfile, 9);
    enfiler_PFile(pfile, 0);
    enfiler_PFile(pfile, 1);
    enfiler_PFile(pfile, 22);
    enfiler_PFile(pfile, 7);
