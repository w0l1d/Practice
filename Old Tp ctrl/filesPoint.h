#ifndef FILESPOINT_H_INCLUDED
#define FILESPOINT_H_INCLUDE


/*
//definir la structure de cellule d'une liste
typedef struct cellule
{

        int valeur;//element de la cellule
        struct cellule *suivant;//pointeur suivant

}Cellule;
*/

//definir la structure de la file
...
int acceder_Tete (MaFile file)
{
    ...
    la t�te de la file*/
    if((!pFile_Vide(file)))  return (int)file.tete->valeur;
